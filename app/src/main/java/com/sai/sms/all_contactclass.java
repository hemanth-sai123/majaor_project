...
public class all_contactclass extends AppCompatActivity {
    ListView listView;
    TextView textView;
    String[] listItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent i=new Intent(all_contactclass.this,showeachallcontact.class);
                i.putExtras(b);
                startActivity(i);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if(!k.isEmpty() && kk.length()==10) {
                                    ...
                                    cont.scanmethodt(k, kk);
                                    Toast.makeText(all_contactclass.this, "ADDED", Toast.LENGTH_SHORT).show();
                                    Intent i=new Intent( all_contactclass.this,all_contactclass.class);
                                    startActivity(i);
                                    finish();
                                }
                                else
                                {
                                    Toast.makeText(all_contactclass.this, "Sorry not saved", Toast.LENGTH_SHORT).show();
                                }
