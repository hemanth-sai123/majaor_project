...
public class see_ImageHelper extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "SCAml";
    private static final String TABLE_CONTACTS = "SCANTABLp";
    private static final String KEY_ID = "data";
    private static final String KEY_NAME = "data";
    private static final String KEY_PH_NO = "phone_number";
    private static final String KEY_IMAGE = "image";

    public see_ImageHelper(Context context) {
