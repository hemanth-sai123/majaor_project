...
public class seecontactsdetails extends AppCompatActivity {
    ListView listView;
    TextView textView;
    String[] listItem;
    public seecontactdatabase con=new seecontactdatabase(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent i=new Intent(seecontactsdetails.this,showeachpolicecontact.class);
                i.putExtras(b);
                startActivity(i);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if(!k.isEmpty() && kk.length()==10) {
                                    ...
                                    Toast.makeText(seecontactsdetails.this, "ADDED", Toast.LENGTH_SHORT).show();
                                    Intent i=new Intent( seecontactsdetails.this,seecontactsdetails.class);
                                    startActivity(i);
                                    finish();
                                }
                                else
                                {
                                    Toast.makeText(seecontactsdetails.this, "Sorry not saved", Toast.LENGTH_SHORT).show();
                                }
