...
public class seecontactdatabase extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "POLICE_PHONE";
    private static final String TABLE_CONTACTS = "POLTABLE";
    ...
    public seecontactdatabase(Context context) {
