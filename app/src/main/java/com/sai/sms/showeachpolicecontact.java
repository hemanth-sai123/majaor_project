...
public class showeachpolicecontact extends AppCompatActivity {
    public seecontactdatabase cont=new seecontactdatabase(this);
    String phonenum="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Intent i=new Intent( showeachpolicecontact.this,all_contactclass.class);
            startActivity(i);
            finish();
        }
        try{
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                androidx.appcompat.app.AlertDialog.Builder alertDialog = new AlertDialog.Builder(showeachpolicecontact.this);
                alertDialog.setTitle("CONTACT");
                alertDialog.setMessage("EDIING CONTACT");

                LinearLayout layout = new LinearLayout(showeachpolicecontact.this);
                layout.setOrientation(LinearLayout.VERTICAL);

                // Add a TextView here for the "Title" label, as noted in the comments
                final EditText username = new EditText(showeachpolicecontact.this);
                username.setHint("Name");
                username.setText(user);
                layout.addView(username); // Notice this is an add method

                // Add another TextView here for the "Description" label
                final EditText phone = new EditText(showeachpolicecontact.this);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if(!k.isEmpty() && kk.length()==10) {
                                    ...
                                    Toast.makeText(showeachpolicecontact.this, "Contact saved", Toast.LENGTH_SHORT).show();
                                    Intent icontact=new Intent( showeachpolicecontact.this,showeachpolicecontact.class);
                                ...
                                {
                                    Toast.makeText(showeachpolicecontact.this, "Sorry not saved", Toast.LENGTH_SHORT).show();
                                }
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(showeachpolicecontact.this);
                ...
                alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Toast.makeText(showeachpolicecontact.this, "Deleted", Toast.LENGTH_SHORT).show();
                        Intent i=new Intent( showeachpolicecontact.this,all_contactclass.class);
                        startActivity(i);
                        finish();
                    }
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View arg0) {
                if (ActivityCompat.checkSelfPermission(showeachpolicecontact.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)
                {
                    ActivityCompat.requestPermissions(showeachpolicecontact.this,new String[]{Manifest.permission.CAMERA}, 1);
                }
                else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CAMERA_REQUEST) {
            ...
            //help.scanmethod("helloll",image); */
                ...
                Intent icontat=new Intent( showeachpolicecontact.this,showeachpolicecontact.class);
